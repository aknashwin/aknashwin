...
|---|---|---|
| 🏭 [Digital Twin Dashboard](https://github.com/aknashwin/digital-twin-dashboard) | Real-time industrial monitoring dashboard with live sensor telemetry, KPI tiles & threshold alerts | Python, FastAPI, WebSockets |
| 🔍 [Vision-Based Object Detection](https://github.com/aknashwin/vision-detection-localization) | YOLOv8 pipeline for real-time object detection | Python, YOLOv8, OpenCV |
| 😊 [Real-Time Emotion Detection](https://github.com/aknashwin/emotion-detection) | Facial emotion classification with live camera | Python, DeepFace, TensorFlow |
